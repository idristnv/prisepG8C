...
<html>
    ...
    <body>
        ...
        <div class="AjouterMaison">
            ...
            <input type="text" name="roomNameInput" required maxlength="200" size="40" placeholder="Nom de la pièce où sera la multiprise">
            ...
            <br/> <br/> <br/>
                ...
                minlength="4" maxlength="200" size="40" placeholder="Saisissez le numéro de série de votre multiprise">
