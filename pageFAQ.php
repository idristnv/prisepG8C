...
<html>
    ...
    <body>
        ...
        <br>
        <h2>Est-il possible d'avoir plusieurs multiprises dans un même pièce?</h2>
        <br>
        <p>Oui bien entendu, il suffit de cliquer sur le bouton "+".</p>
        <br>
        <h2>Est-il possible d'indiquer plusieurs domiciles?</h2>
        <br>
        <p>Oui, tout comme pour les multiprises, il s'agit de la même méthode d'ajout.</p>
        <br>
